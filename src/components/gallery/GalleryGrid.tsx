...
const GALLERY: GalleryImage[] = [
  { id: "1", src: "", alt: "Gel nail art — pink and white design", category: "Nails", gradient: "from-primary/80 to-rose/60" },
  { id: "2", src: "", alt: "Builder gel extensions — natural nude", category: "Nails", gradient: "from-soft-pink/90 to-primary/40" },
  { id: "3", src: "", alt: "Lash lift before and after results", category: "Lashes", gradient: "from-dark/80 to-primary/40" },
  { id: "4", src: "", alt: "Eyebrow lamination — fluffy defined brows", category: "Brows", gradient: "from-gold/70 to-rose/70" },
  { id: "5", src: "", alt: "Get The Glow facial treatment", category: "Facials", gradient: "from-cream/90 to-rose/60" },
  { id: "6", src: "", alt: "Hair balayage colour transformation", category: "Hair", gradient: "from-gold/80 to-primary/60" },
  { id: "7", src: "", alt: "Threading — perfect brow shape", category: "Threading", gradient: "from-primary/70 to-dark/60" },
  { id: "8", src: "", alt: "Hot stone massage treatment", category: "Massage", gradient: "from-dark/70 to-rose/50" },
  { id: "9", src: "", alt: "French builder gel nails", category: "Nails", gradient: "from-soft-pink/80 to-gold/50" },
  { id: "10", src: "", alt: "Hair styling — bouncy blowdry", category: "Hair", gradient: "from-rose/70 to-primary/80" },
  { id: "11", src: "", alt: "Gold facial treatment", category: "Facials", gradient: "from-gold/80 to-rose/60" },
        ...
        {filtered.map((img, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <p className="text-white text-xs font-medium text-center px-3 font-body">
                {img.alt}
              </p>
            </div>
            {/* Category badge */}
            <div className="absolute top-2 left-2 bg-black/30 text-white text-[10px] px-2 py-0.5 rounded-full font-medium">
              {img.category}
            </div>
            {/* Hover overlay */}
